...
const commands:Command[]=["PAYROLL_DRAFT","ATTENDANCE_DRAFT","ATTENDANCE_APPROVE","PAY_RUN_APPROVE","PAY_RUN_FINALIZE","PAYSLIP_RELEASE","CLOCK_EVENT","EMPLOYEE_READ","EMPLOYEE_MANAGE","EMPLOYEE_DEACTIVATE"];
const principals:{name:string;actor:Actor;allowed:Command[]}[]=[
 ...
 {name:"stale owner",actor:{...owner,mfaSatisfiedAt:new Date(now.getTime()-660000)},allowed:["PAYROLL_DRAFT","ATTENDANCE_DRAFT","EMPLOYEE_READ","EMPLOYEE_MANAGE"]},
 {name:"accountant",actor:{...owner,role:"accountant"},allowed:["PAYROLL_DRAFT","ATTENDANCE_DRAFT","EMPLOYEE_READ","EMPLOYEE_MANAGE"]},
